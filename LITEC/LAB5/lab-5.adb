...
S:Llab_5.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:Llab_5.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:Llab_5.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:Llab_5.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
F:G$set_gains$0$0({2}DF,SV:S),Z,0,0,0,0,0
S:Llab_5.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:Llab_5.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:Llab_5.aligned_alloc$size$1$26({2}SI:U),E,0,0
S:Llab_5.aligned_alloc$alignment$1$26({2}SI:U),E,0,0
S:Llab_5.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:Llab_5.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:Llab_5.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:Llab_5.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:Llab_5.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:Llab_5.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:Llab_5.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:Llab_5.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:Llab_5.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:Llab_5.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:Llab_5.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:Llab_5.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:Llab_5.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:Llab_5.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:Llab_5.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:Llab_5.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:Llab_5.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:Llab_5.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
...
S:G$ks$0$0({1}SC:U),E,0,0
S:G$kdx$0$0({1}SC:U),E,0,0
S:G$kdy$0$0({1}SC:U),E,0,0
S:G$levelflag$0$0({1}SC:U),E,0,0
S:G$nCounts$0$0({2}SI:U),E,0,0
S:G$direction$0$0({1}SC:U),E,0,0
S:G$Constant$0$0({2}SI:S),E,0,0
S:G$avg_gx$0$0({2}SI:S),E,0,0
S:G$avg_gy$0$0({2}SI:S),E,0,0
S:Llab_5.main$run_stop$1$132({1}SC:U),R,0,0,[r7]
S:Llab_5.main$keypad$4$135({1}SC:U),R,0,0,[r6]
S:Llab_5.read_AD_input$cast$1$166({1}SC:U),E,0,0
S:Llab_5.read_AD_input$n$1$166({1}SC:U),R,0,0,[]
S:Llab_5.read_AD_input$adcast$1$167({1}SC:U),R,0,0,[]
S:Llab_5.calibration$addr$1$181({1}SC:U),R,0,0,[r7]
S:Llab_5.calibration$i$1$181({1}SC:U),R,0,0,[]
S:Llab_5.read_accels$addr$1$185({1}SC:U),R,0,0,[r7]
S:Llab_5.read_accels$i$1$185({1}SC:U),R,0,0,[]
S:Llab_5.set_gains$keypad$1$197({1}SC:U),R,0,0,[r7]
S:Llab_5.set_gains$var$4$204({1}SC:U),R,0,0,[r6]
S:Llab_5.set_gains$var$4$217({1}SC:U),R,0,0,[r6]
S:Llab_5.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:G$Update_Value$0$0({2}DF,SV:S),C,0,0
S:G$read_accel$0$0({2}DF,SV:S),C,0,0
S:G$pick_heading$0$0({2}DF,SI:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:Flab_5$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:Flab_5$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:Flab_5$__str_3$0$0({46}DA46d,SC:S),D,0,0
S:Flab_5$__str_4$0$0({12}DA12d,SC:S),D,0,0
S:Flab_5$__str_5$0$0({15}DA15d,SC:S),D,0,0
S:Flab_5$__str_6$0$0({17}DA17d,SC:S),D,0,0
S:Flab_5$__str_7$0$0({6}DA6d,SC:S),D,0,0
S:Flab_5$__str_8$0$0({5}DA5d,SC:S),D,0,0
S:Flab_5$__str_9$0$0({35}DA35d,SC:S),D,0,0
S:Flab_5$__str_10$0$0({14}DA14d,SC:S),D,0,0
S:Flab_5$__str_11$0$0({55}DA55d,SC:S),D,0,0
S:Flab_5$__str_12$0$0({8}DA8d,SC:S),D,0,0
S:Flab_5$__str_13$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_14$0$0({8}DA8d,SC:S),D,0,0
S:Flab_5$__str_15$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_16$0$0({8}DA8d,SC:S),D,0,0
S:Flab_5$__str_17$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_18$0$0({8}DA8d,SC:S),D,0,0
S:Flab_5$__str_19$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_20$0$0({56}DA56d,SC:S),D,0,0
S:Flab_5$__str_21$0$0({3}DA3d,SC:S),D,0,0
S:Flab_5$__str_22$0$0({17}DA17d,SC:S),D,0,0
S:Flab_5$__str_23$0$0({60}DA60d,SC:S),D,0,0
S:Flab_5$__str_24$0$0({8}DA8d,SC:S),D,0,0
S:Flab_5$__str_25$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_26$0$0({8}DA8d,SC:S),D,0,0
S:Flab_5$__str_27$0$0({16}DA16d,SC:S),D,0,0
S:Flab_5$__str_28$0$0({9}DA9d,SC:S),D,0,0
S:Flab_5$__str_29$0$0({17}DA17d,SC:S),D,0,0

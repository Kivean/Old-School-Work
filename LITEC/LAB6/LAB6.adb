...
F:G$set_tail_PWM$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$set_gains$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$tilt_set$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$thrust_set$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:LLAB6.aligned_alloc$size$1$26({2}SI:U),E,0,0
S:LLAB6.aligned_alloc$alignment$1$26({2}SI:U),E,0,0
...
S:G$TAIL_PW$0$0({2}SI:U),E,0,0
S:G$LEFT_PW$0$0({2}SI:U),E,0,0
S:G$SERVO_CENTER$0$0({2}SI:U),E,0,0
S:G$SERVO_MAX$0$0({2}SI:U),E,0,0
S:G$SERVO_MIN$0$0({2}SI:U),E,0,0
S:G$SERVO_PW$0$0({2}SI:U),E,0,0
S:G$kp$0$0({1}SC:U),E,0,0
S:G$kd$0$0({1}SC:U),E,0,0
S:G$prev_error$0$0({2}SI:S),E,0,0
S:G$h_switch$0$0({1}SC:U),E,0,0
S:G$battery$0$0({1}SC:U),E,0,0
S:G$new_heading$0$0({1}SC:U),E,0,0
S:G$range$0$0({2}SI:U),E,0,0
S:G$heading$0$0({2}SI:U),E,0,0
S:G$prev_range$0$0({2}SI:U),E,0,0
S:G$h_count$0$0({1}SC:U),E,0,0
S:G$nCounts$0$0({1}SC:U),E,0,0
S:G$xCounts$0$0({1}SC:U),E,0,0
...
S:LLAB6.read_compass$addr$1$151({1}SC:U),R,0,0,[]
S:LLAB6.read_compass$compheading$1$151({2}SI:U),R,0,0,[]
S:LLAB6.read_ranger$addr$1$153({1}SC:U),R,0,0,[]
S:LLAB6.set_tail_PWM$sloc0$1$0({4}SL:S),E,0,0
S:LLAB6.set_gains$keypad$1$161({1}SC:U),R,0,0,[r7]
S:LLAB6.set_gains$var$1$161({1}SC:U),R,0,0,[r6]
S:LLAB6.main$sloc0$1$0({1}SB0$0:S),H,0,0
...
S:FLAB6$__str_3$0$0({74}DA74d,SC:S),D,0,0
S:FLAB6$__str_4$0$0({11}DA11d,SC:S),D,0,0
S:FLAB6$__str_5$0$0({17}DA17d,SC:S),D,0,0
S:FLAB6$__str_6$0$0({48}DA48d,SC:S),D,0,0
S:FLAB6$__str_7$0$0({3}DA3d,SC:S),D,0,0
S:FLAB6$__str_8$0$0({15}DA15d,SC:S),D,0,0
S:FLAB6$__str_9$0$0({48}DA48d,SC:S),D,0,0
S:FLAB6$__str_10$0$0({15}DA15d,SC:S),D,0,0
S:FLAB6$__str_11$0$0({9}DA9d,SC:S),D,0,0

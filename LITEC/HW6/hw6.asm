...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw6.c$41$1$12 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:41: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw6.c$43$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:43: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw6.c$44$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:44: putchar(' ');    // the quote fonts may not copy correctly into SiLabs IDE
	mov	dpl,#0x20
	lcall	_putchar
	C$hw6.c$45$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:45: Port_Init();
	lcall	_Port_Init
	C$hw6.c$46$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:46: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw6.c$47$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:47: Timer_Init();    // Initialize Timer 0 
	lcall	_Timer_Init
	C$hw6.c$49$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:49: while (1) /* the following loop contains the button pressing/tracking code */
00118$:
	C$hw6.c$51$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:51: counts = 0;
	clr	a
	mov	_counts,a
	mov	(_counts + 1),a
	C$hw6.c$52$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:52: printf("Enter a keyboard character to begin \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw6.c$53$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:53: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw6.c$54$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:54: printf("Push the button as many times as you like in 20 seconds \r\n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw6.c$55$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:55: TR0 = 1;
	setb	_TR0
	C$hw6.c$56$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:56: while (counts < 54007) //20 seconds is 54.006.9 overflows
00114$:
	clr	c
	mov	a,_counts
	subb	a,#0xf7
	...
	jnc	00116$
	C$hw6.c$58$3$34 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:58: if (!PB) //push button pressed
	jb	_PB,00114$
	C$hw6.c$60$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:60: current = counts; //record time of push
	mov	_current,_counts
	mov	(_current + 1),(_counts + 1)
	C$hw6.c$61$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:61: wait = counts + 54; //takes 54 overflows to make 20 ms
	mov	a,#0x36
	add	a,_counts
	mov	_wait,a
	clr	a
	...
	mov	(_wait + 1),a
	C$hw6.c$62$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:62: while (counts != wait) //debouncing delay
00101$:
	mov	a,_wait
	cjne	a,_counts,00101$
	mov	a,(_wait + 1)
	cjne	a,(_counts + 1),00101$
	C$hw6.c$66$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:66: button ++; //increment button counter
	inc	_button
	C$hw6.c$67$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:67: while (!PB) //wait for button release
00104$:
	jnb	_PB,00104$
	C$hw6.c$71$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:71: wait = counts + 54; //54 overflows is 24 ms
	mov	a,#0x36
	add	a,_counts
	mov	_wait,a
	clr	a
	...
	mov	(_wait + 1),a
	C$hw6.c$72$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:72: while (counts != wait) //debouncing delay
00107$:
	mov	a,_wait
	cjne	a,_counts,00107$
	mov	a,(_wait + 1)
	cjne	a,(_counts + 1),00107$
	C$hw6.c$76$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:76: current = counts - current; //record total time of push
	mov	a,_counts
	clr	c
	subb	a,_current
	mov	_current,a
	...
	mov	(_current + 1),a
	C$hw6.c$77$4$35 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:77: if (current > 2700) //2700 counts to 1 second
	clr	c
	mov	a,#0x8c
	subb	a,_current
	mov	a,#0x0a
	...
	jnc	00114$
	C$hw6.c$79$5$39 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:79: longbutton ++; //incremenet long press count
	inc	_longbutton
	sjmp	00114$
00116$:
	C$hw6.c$83$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:83: printf("Button was pressed %i times\r\n", button);
	mov	r6,_button
	mov	r7,#0x00
	push	ar6
	push	ar7
	...
	mov	sp,a
	C$hw6.c$84$2$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:84: printf("Button was long pressed %i times\r\n", longbutton);
	mov	r6,_longbutton
	mov	r7,#0x00
	push	ar6
	push	ar7
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$hw6.c$90$1$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:90: void Port_Init(void)
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$hw6.c$92$1$41 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:92: P2MDOUT &= 0xFB;
	anl	_P2MDOUT,#0xfb
	C$hw6.c$93$1$41 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:93: P2 |= ~0xFB;
	orl	_P2,#0x04
	C$hw6.c$94$1$41 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	...
	C$hw6.c$98$1$41 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:98: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw6.c$100$1$43 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:100: ET0 = 1;      // enable Timer0 Interrupt request
	setb	_ET0
	C$hw6.c$101$1$43 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:101: EA = 1;       // enable global interrupts
	setb	_EA
	C$hw6.c$102$1$43 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw6.c$105$1$43 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:105: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw6.c$108$1$45 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:108: CKCON |= 0x08;  // Timer0 uses SYSCLK or SYSCLK/12
	orl	_CKCON,#0x08
	C$hw6.c$109$1$45 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:109: TMOD &= 0xF0;   // clear the 4 least significant bits, max for 13 bits is 8191, each interrupt happens after .370323 ms
	anl	_TMOD,#0xf0
	C$hw6.c$111$1$45 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:111: TR0 = 0;         // Stop Timer0
	clr	_TR0
	C$hw6.c$112$1$45 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:112: TL0 = 0;         // Clear low byte of register T0
	mov	_TL0,#0x00
	C$hw6.c$113$1$45 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:113: TH0 = 0;         // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw6.c$115$1$45 ==.
	XG$Timer_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw6.c$119$1$45 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:119: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$hw6.c$121$1$47 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW6\hw6.c:121: counts ++;
	inc	_counts
	clr	a
...
Fhw6$__str_2$0$0 == .
___str_2:
	.ascii "Button was pressed %i times"
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw6$__str_3$0$0 == .
___str_3:
	.ascii "Button was long pressed %i times"
	.db 0x0d
	.db 0x0a
	.db 0x00
	.area XINIT   (CODE)

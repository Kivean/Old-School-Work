...
S:LkpdlcdtestPCA.main$keypad$1$122({1}SC:U),R,0,0,[r7]
S:LkpdlcdtestPCA.main$cool$1$122({1}SC:U),R,0,0,[r6]
...
S:FkpdlcdtestPCA$__str_5$0$0({44}DA44d,SC:S),D,0,0
S:FkpdlcdtestPCA$__str_6$0$0({30}DA30d,SC:S),D,0,0
S:FkpdlcdtestPCA$__str_7$0$0({37}DA37d,SC:S),D,0,0
S:FkpdlcdtestPCA$__str_8$0$0({45}DA45d,SC:S),D,0,0

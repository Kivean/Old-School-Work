...
F:G$Game1$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Game2$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Game3$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$LEDLighter$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Flash$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Flashall$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$compare$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$Port_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$ADC_Init$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$read_AD_input$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$Draw_Bar$0$0({2}DF,SV:S),Z,0,0,0,0,0
...
S:G$overflows$0$0({10}DA5d,SI:U),E,0,0
S:G$counts$0$0({2}SI:U),E,0,0
S:G$adcast$0$0({2}SI:U),E,0,0
S:G$current$0$0({2}SI:U),E,0,0
S:G$wait$0$0({2}SI:U),E,0,0
S:G$gamecounts$0$0({2}SI:U),E,0,0
S:G$score$0$0({2}SI:U),E,0,0
S:G$gamescore$0$0({2}SI:U),E,0,0
S:G$tries$0$0({1}SC:U),E,0,0
S:G$light$0$0({1}SC:U),E,0,0
S:G$pot$0$0({1}SC:U),E,0,0
S:G$flash$0$0({1}SC:U),E,0,0
S:G$error$0$0({1}SC:U),E,0,0
S:G$button$0$0({1}SC:U),E,0,0
S:G$prev$0$0({1}SC:U),E,0,0
S:G$cur$0$0({1}SC:U),E,0,0
S:G$seed$0$0({1}SC:U),E,0,0
S:LLAB2.aligned_alloc$size$1$39({2}SI:U),E,0,0
S:LLAB2.aligned_alloc$alignment$1$39({2}SI:U),E,0,0
S:LLAB2.read_AD_input$cast$1$124({1}SC:U),E,0,0
S:LLAB2.read_AD_input$n$1$124({1}SC:U),R,0,0,[]
S:LLAB2.Draw_Bar$length$1$128({1}SC:U),R,0,0,[r7]
S:LLAB2.Draw_Bar$i$1$129({1}SC:U),R,0,0,[r6]
...
S:FLAB2$__str_0$0$0({49}DA49d,SC:S),D,0,0
S:FLAB2$__str_1$0$0({73}DA73d,SC:S),D,0,0
S:FLAB2$__str_2$0$0({30}DA30d,SC:S),D,0,0
S:FLAB2$__str_3$0$0({122}DA122d,SC:S),D,0,0
S:FLAB2$__str_4$0$0({97}DA97d,SC:S),D,0,0
S:FLAB2$__str_5$0$0({70}DA70d,SC:S),D,0,0
S:FLAB2$__str_6$0$0({54}DA54d,SC:S),D,0,0
S:FLAB2$__str_7$0$0({123}DA123d,SC:S),D,0,0
S:FLAB2$__str_8$0$0({89}DA89d,SC:S),D,0,0
S:FLAB2$__str_9$0$0({142}DA142d,SC:S),D,0,0
S:FLAB2$__str_10$0$0({71}DA71d,SC:S),D,0,0

...
S:LLab4andahalf.lcd_print$fmt$1$80({3}DG,SC:U),B,1,-5
S:LLab4andahalf.lcd_print$len$1$81({1}SC:U),R,0,0,[r6]
S:LLab4andahalf.lcd_print$i$1$81({1}SC:U),R,0,0,[]
S:LLab4andahalf.lcd_print$ap$1$81({1}DD,SC:U),R,0,0,[]
...
F:G$read_ranger$0$0({2}DF,SC:U),Z,0,0,0,0,0
F:G$forward_mode$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$reverse_mode$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$set_servo_PWM$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$set_drive_PWM$0$0({2}DF,SV:S),Z,0,0,0,0,0
F:G$pick_heading$0$0({2}DF,SI:S),Z,0,0,0,0,0
F:G$pick_range$0$0({2}DF,SI:S),Z,0,0,0,0,0
...
S:LLab4andahalf.getchar$c$1$10({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.getchar_nw$c$1$12({1}SC:U),R,0,0,[]
S:G$Data2$0$0({3}DA3d,SC:U),E,0,0
S:LLab4andahalf.aligned_alloc$size$1$26({2}SI:U),E,0,0
S:LLab4andahalf.aligned_alloc$alignment$1$26({2}SI:U),E,0,0
S:LLab4andahalf.lcd_clear$NumBytes$1$85({1}SC:U),E,0,0
S:LLab4andahalf.lcd_clear$Cmd$1$85({2}DA2d,SC:U),E,0,0
S:LLab4andahalf.read_keypad$i$1$86({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.read_keypad$Data$1$86({2}DA2d,SC:U),E,0,0
S:LLab4andahalf.kpd_input$mode$1$88({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.kpd_input$sum$1$89({2}SI:U),R,0,0,[r5,r6]
S:LLab4andahalf.kpd_input$key$1$89({1}SC:U),R,0,0,[r3]
S:LLab4andahalf.kpd_input$i$1$89({1}SC:U),R,0,0,[]
S:LLab4andahalf.i2c_write_data$start_reg$1$105({1}SC:U),E,0,0
S:LLab4andahalf.i2c_write_data$buffer$1$105({3}DG,SC:U),E,0,0
S:LLab4andahalf.i2c_write_data$num_bytes$1$105({1}SC:U),E,0,0
S:LLab4andahalf.i2c_write_data$addr$1$105({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.i2c_write_data$i$1$106({1}SC:U),R,0,0,[]
S:LLab4andahalf.i2c_read_data$start_reg$1$107({1}SC:U),E,0,0
S:LLab4andahalf.i2c_read_data$buffer$1$107({3}DG,SC:U),E,0,0
S:LLab4andahalf.i2c_read_data$num_bytes$1$107({1}SC:U),E,0,0
S:LLab4andahalf.i2c_read_data$addr$1$107({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.i2c_read_data$j$1$108({1}SC:U),R,0,0,[]
S:G$MOTOR_STOP$0$0({2}SI:U),E,0,0
S:G$MOTOR_MAX$0$0({2}SI:U),E,0,0
S:G$MOTOR_MIN$0$0({2}SI:U),E,0,0
S:G$MOTOR_PW$0$0({2}SI:U),E,0,0
S:G$SERVO_CENTER$0$0({2}SI:U),E,0,0
S:G$SERVO_RIGHT$0$0({2}SI:U),E,0,0
S:G$SERVO_LEFT$0$0({2}SI:U),E,0,0
S:G$SERVO_PW$0$0({2}SI:U),E,0,0
S:G$new_heading$0$0({1}SC:U),E,0,0
S:G$new_range$0$0({1}SC:U),E,0,0
S:G$print_flag$0$0({1}SC:U),E,0,0
S:G$range$0$0({2}SI:U),E,0,0
S:G$light$0$0({2}SI:U),E,0,0
S:G$heading$0$0({2}SI:U),E,0,0
S:G$r_count$0$0({1}SC:U),E,0,0
S:G$h_count$0$0({1}SC:U),E,0,0
S:G$print_count$0$0({1}SC:U),E,0,0
S:G$nCounts$0$0({1}SC:U),E,0,0
S:G$desired_heading$0$0({2}SI:U),E,0,0
S:G$desired_range$0$0({2}SI:U),E,0,0
S:G$error$0$0({2}SI:S),E,0,0
S:G$deriv$0$0({2}SI:S),E,0,0
S:G$obstacle_threshold$0$0({1}SC:U),E,0,0
S:G$brightness_threshold$0$0({1}SC:U),E,0,0
S:G$Data$0$0({2}DA2d,SC:U),E,0,0
S:G$ranger_select$0$0({1}SC:U),E,0,0
S:G$drivegain$0$0({1}SC:U),E,0,0
S:G$run_stop$0$0({1}SC:U),E,0,0
S:G$set_heading$0$0({2}SI:U),E,0,0
S:G$pot_val$0$0({1}SC:U),E,0,0
S:LLab4andahalf.read_compass$addr$1$154({1}SC:U),R,0,0,[]
S:LLab4andahalf.read_compass$compheading$1$154({2}SI:U),R,0,0,[]
S:LLab4andahalf.read_ranger$addr$1$156({1}SC:U),R,0,0,[]
S:LLab4andahalf.read_ranger$lightlevel$1$156({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.set_drive_PWM$distance$1$171({2}SI:U),R,0,0,[r6,r7]
S:LLab4andahalf.pick_heading$keypad$1$178({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.pick_heading$var$4$185({1}SC:U),R,0,0,[r6]
S:LLab4andahalf.pick_range$keypad$1$193({1}SC:U),R,0,0,[r7]
S:LLab4andahalf.pick_range$var$1$193({1}SC:U),R,0,0,[r6]
S:LLab4andahalf.read_AD_input$cast$1$198({1}SC:U),E,0,0
S:LLab4andahalf.read_AD_input$n$1$198({1}SC:U),R,0,0,[]
S:LLab4andahalf.read_AD_input$adcast$1$199({1}SC:U),R,0,0,[]
S:LLab4andahalf.lcd_print$text$1$81({80}DA80d,SC:U),F,0,0
...
S:G$read_light$0$0({2}DF,SI:S),C,0,0
S:G$main$0$0({2}DF,SV:S),C,0,0
S:FLab4andahalf$__str_0$0$0({22}DA22d,SC:S),D,0,0
S:FLab4andahalf$__str_1$0$0({16}DA16d,SC:S),D,0,0
S:FLab4andahalf$__str_2$0$0({3}DA3d,SC:S),D,0,0
S:FLab4andahalf$__str_3$0$0({70}DA70d,SC:S),D,0,0
S:FLab4andahalf$__str_4$0$0({11}DA11d,SC:S),D,0,0
S:FLab4andahalf$__str_5$0$0({30}DA30d,SC:S),D,0,0
S:FLab4andahalf$__str_6$0$0({27}DA27d,SC:S),D,0,0
S:FLab4andahalf$__str_7$0$0({63}DA63d,SC:S),D,0,0
S:FLab4andahalf$__str_8$0$0({11}DA11d,SC:S),D,0,0
S:FLab4andahalf$__str_9$0$0({19}DA19d,SC:S),D,0,0
S:FLab4andahalf$__str_10$0$0({12}DA12d,SC:S),D,0,0
S:FLab4andahalf$__str_11$0$0({20}DA20d,SC:S),D,0,0
S:FLab4andahalf$__str_12$0$0({13}DA13d,SC:S),D,0,0
S:FLab4andahalf$__str_13$0$0({21}DA21d,SC:S),D,0,0
S:FLab4andahalf$__str_14$0$0({13}DA13d,SC:S),D,0,0
S:FLab4andahalf$__str_15$0$0({21}DA21d,SC:S),D,0,0
S:FLab4andahalf$__str_16$0$0({56}DA56d,SC:S),D,0,0
S:FLab4andahalf$__str_17$0$0({3}DA3d,SC:S),D,0,0
S:FLab4andahalf$__str_18$0$0({20}DA20d,SC:S),D,0,0
S:FLab4andahalf$__str_19$0$0({64}DA64d,SC:S),D,0,0
S:FLab4andahalf$__str_20$0$0({18}DA18d,SC:S),D,0,0

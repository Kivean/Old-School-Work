...
S:G$counts$0$0({4}SL:U),E,0,0
S:G$var$0$0({2}SI:U),E,0,0
...
S:Fhw5$__str_0$0$0({40}DA40d,SC:S),D,0,0
S:Fhw5$__str_1$0$0({30}DA30d,SC:S),D,0,0
S:Fhw5$__str_2$0$0({28}DA28d,SC:S),D,0,0
S:Fhw5$__str_3$0$0({26}DA26d,SC:S),D,0,0

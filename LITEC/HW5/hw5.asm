...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$hw5.c$51$1$12 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:51: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$hw5.c$53$1$31 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:53: Sys_Init();      // System Initialization
	lcall	_Sys_Init
	C$hw5.c$54$1$31 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:54: putchar(' ');    
	mov	dpl,#0x20
	lcall	_putchar
	C$hw5.c$55$1$31 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:55: Interrupt_Init();
	lcall	_Interrupt_Init
	C$hw5.c$56$1$31 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:56: Timer_Init();    // Initialize Timer 0 
	lcall	_Timer_Init
	C$hw5.c$58$1$31 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:58: while (1) /* the following loop waits until a key is pressed on the
00110$:
	C$hw5.c$62$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:62: printf("Hit any key on the keyboard to start \r\n");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$63$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:63: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$hw5.c$65$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:65: TH0 = 0; //set high bits to 0
	mov	_TH0,#0x00
	C$hw5.c$66$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:66: TL0 = 0; //set low bits to 0
	mov	_TL0,#0x00
	C$hw5.c$67$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:67: TR0 = 1; //start timer
	setb	_TR0
	C$hw5.c$74$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:74: while (counts != 6750) //&& (TH0 * 256 + TL0) != 7044)
00102$:
	mov	a,#0x5e
	cjne	a,_counts,00147$
	mov	a,#0x1a
	cjne	a,(_counts + 1),00147$
	clr	a
	cjne	a,(_counts + 2),00147$
	cjne	a,(_counts + 3),00147$
	sjmp	00104$
00147$:
	C$hw5.c$76$3$33 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:76: for(var = 0; var<100; var++); //useless commands
	mov	_var,#0x64
	mov	(_var + 1),#0x00
00114$:
	dec	_var
...
00104$:
	C$hw5.c$83$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:83: printf("\r\n2.5 seconds have passed. \r\n");  	//print that the time has elapsed
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$85$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:85: printf("There were %ld overflows \r\n", counts);	// print number of overflows using count variable
	push	_counts
	push	(_counts + 1)
	push	(_counts + 2)
	push	(_counts + 3)
	...
	mov	sp,a
	C$hw5.c$87$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:87: TH0 = 0; //set high bits to 0 again
	C$hw5.c$88$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:88: TL0 = 0; //set low bits to 0 again
	C$hw5.c$89$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:89: counts = 0; //reset counts
	clr	a
	mov	_TH0,a
	mov	_TL0,a
	mov	_counts,a
	...
	mov	(_counts + 3),a
	C$hw5.c$91$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:91: while (counts != 8101) //&& (TH0 * 256 + TL0) != 246)
00106$:
	mov	a,#0xa5
	cjne	a,_counts,00150$
	mov	a,#0x1f
	cjne	a,(_counts + 1),00150$
	clr	a
	cjne	a,(_counts + 2),00150$
	cjne	a,(_counts + 3),00150$
	sjmp	00108$
00150$:
	C$hw5.c$93$3$34 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:93: for(var = 0; var<100; var++); //useless commands
	mov	_var,#0x64
	mov	(_var + 1),#0x00
00117$:
	dec	_var
...
00108$:
	C$hw5.c$100$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:100: printf("3 seconds have passed. \r\n");  	//print that the time has elapsed
	mov	a,#___str_3
	push	acc
	mov	a,#(___str_3 >> 8)
	push	acc
	...
	dec	sp
	C$hw5.c$102$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:102: printf("There were %ld overflows \r\n", counts);	// print number of overflows using count variable
	push	_counts
	push	(_counts + 1)
	push	(_counts + 2)
	push	(_counts + 3)
	...
	mov	sp,a
	C$hw5.c$104$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:104: TR0 = 0; //stop timer
	clr	_TR0
	C$hw5.c$105$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:105: TH0 = 0; //set high bits to 0
	C$hw5.c$106$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:106: TL0 = 0; //set low bits to 0
	C$hw5.c$107$2$32 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:107: counts = 0; //reset counts
	clr	a
	mov	_TH0,a
	mov	_TL0,a
	mov	_counts,a
...
;------------------------------------------------------------
	...
	C$hw5.c$113$1$31 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:113: void Interrupt_Init(void)
;	-----------------------------------------
;	 function Interrupt_Init
;	-----------------------------------------
_Interrupt_Init:
	C$hw5.c$115$1$36 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:115: ET0 = 1;      // enable Timer0 Interrupt request using sbit variable 
	setb	_ET0
	C$hw5.c$116$1$36 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:116: IE |= 0x80;   // enable global interrupts using bit masking (EA = 1)
	orl	_IE,#0x80
	C$hw5.c$117$1$36 ==.
...
;------------------------------------------------------------
	G$Timer_Init$0$0 ==.
	C$hw5.c$119$1$36 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:119: void Timer_Init(void)
;	-----------------------------------------
;	 function Timer_Init
;	-----------------------------------------
_Timer_Init:
	C$hw5.c$122$1$38 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:122: CKCON |= 0x08;  // Timer0 uses SYSCLK or SYSCLK/12
	orl	_CKCON,#0x08
	C$hw5.c$123$1$38 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:123: TMOD &= 0xF0;   // clear the 4 least significant bits, max for 13 bits is 8191, each interrupt happens after .370323 ms
	anl	_TMOD,#0xf0
	C$hw5.c$125$1$38 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:125: TR0 = 0;         // Stop Timer0
	clr	_TR0
	C$hw5.c$126$1$38 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:126: TL0 = 0;         // Clear low byte of register T0
	mov	_TL0,#0x00
	C$hw5.c$127$1$38 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:127: TH0 = 0;         // Clear high byte of register T0
	mov	_TH0,#0x00
	C$hw5.c$129$1$38 ==.
	XG$Timer_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$Timer0_ISR$0$0 ==.
	C$hw5.c$133$1$38 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:133: void Timer0_ISR(void) __interrupt 1
;	-----------------------------------------
;	 function Timer0_ISR
;	-----------------------------------------
_Timer0_ISR:
	...
	push	psw
	C$hw5.c$135$1$40 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:135: counts ++;
	inc	_counts
	clr	a
...
00103$:
	C$hw5.c$136$1$40 ==.
;	C:\Users\gerlig\Documents\School\LITEC\HW5\hw5.c:136: TF0 = 0;
	clr	_TF0
	pop	psw
	pop	acc
	C$hw5.c$137$1$40 ==.
...
Fhw5$__str_2$0$0 == .
___str_2:
	.ascii "There were %ld overflows "
	.db 0x0d
	.db 0x0a
	.db 0x00
Fhw5$__str_3$0$0 == .
___str_3:
	.ascii "3 seconds have passed. "
	.db 0x0d
	.db 0x0a
	.db 0x00
	.area XINIT   (CODE)

...
;--------------------------------------------------------
	...
	C$lab3_1.c$17$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:17: unsigned int PW_CENTER = 2760;
	mov	_PW_CENTER,#0xc8
	mov	(_PW_CENTER + 1),#0x0a
	C$lab3_1.c$18$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:18: unsigned int PW_MIN = 2030;
	mov	_PW_MIN,#0xee
	mov	(_PW_MIN + 1),#0x07
	C$lab3_1.c$19$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:19: unsigned int PW_MAX = 3500;
	mov	_PW_MAX,#0xac
	mov	(_PW_MAX + 1),#0x0d
	C$lab3_1.c$20$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:20: unsigned int PW = 0;
	clr	a
	mov	_PW,a
	mov	(_PW + 1),a
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$lab3_1.c$27$1$12 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:27: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$lab3_1.c$30$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:30: Sys_Init();
	lcall	_Sys_Init
	C$lab3_1.c$31$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:31: putchar(' '); //the quotes in this line may not format correctly
	mov	dpl,#0x20
	lcall	_putchar
	C$lab3_1.c$32$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:32: Port_Init();
	lcall	_Port_Init
	C$lab3_1.c$33$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:33: XBR0_Init();
	lcall	_XBR0_Init
	C$lab3_1.c$34$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:34: PCA_Init();
	lcall	_PCA_Init
	C$lab3_1.c$37$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:37: printf("Embedded Control Pulsewidth Calibration\n\r");
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	C$lab3_1.c$39$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:39: PW = PW_CENTER;
	mov	_PW,_PW_CENTER
	mov	(_PW + 1),(_PW_CENTER + 1)
	C$lab3_1.c$40$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:40: count = 0;
	clr	a
	mov	_count,a
	mov	(_count + 1),a
	C$lab3_1.c$41$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:41: PCA0CP2 = 0xFFFF - PW;
	dec	a
	clr	c
	subb	a,_PW
	...
	C$lab3_1.c$42$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:42: while (count < 75);
00101$:
	clr	c
	mov	a,_count
	subb	a,#0x4b
	...
	jc	00101$
	C$lab3_1.c$46$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:46: while(1)
00105$:
	C$lab3_1.c$47$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:47: Set_Pulsewidth();
...
;------------------------------------------------------------
	G$Port_Init$0$0 ==.
	C$lab3_1.c$56$1$52 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:56: void Port_Init()
;	-----------------------------------------
;	 function Port_Init
;	-----------------------------------------
_Port_Init:
	C$lab3_1.c$58$1$53 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:58: P1MDOUT |= 0x04;  //set output pin for CEX2 in push-pull mode
	orl	_P1MDOUT,#0x04
	C$lab3_1.c$59$1$53 ==.
	XG$Port_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$XBR0_Init$0$0 ==.
	C$lab3_1.c$67$1$53 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:67: void XBR0_Init()
;	-----------------------------------------
;	 function XBR0_Init
;	-----------------------------------------
_XBR0_Init:
	C$lab3_1.c$69$1$54 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:69: XBR0 = 0x27;  //configure crossbar as directed in the laboratory
	mov	_XBR0,#0x27
	C$lab3_1.c$71$1$54 ==.
	XG$XBR0_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$PCA_Init$0$0 ==.
	C$lab3_1.c$79$1$54 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:79: void PCA_Init(void)
;	-----------------------------------------
;	 function PCA_Init
;	-----------------------------------------
_PCA_Init:
	C$lab3_1.c$81$1$56 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:81: PCA0MD = 0x81; //emable CF interrupt and SYSCLK/12
	mov	_PCA0MD,#0x81
	C$lab3_1.c$82$1$56 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:82: PCA0CPM2 = 0xC2; //CCM2 in 16 bit compare mode
	mov	_PCA0CPM2,#0xc2
	C$lab3_1.c$83$1$56 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:83: PCA0CN = 0x40; //enable PCA counter
	mov	_PCA0CN,#0x40
	C$lab3_1.c$84$1$56 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:84: EIE1 |= 0x08;
	orl	_EIE1,#0x08
	C$lab3_1.c$85$1$56 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:85: EA = 1;
	setb	_EA
	C$lab3_1.c$87$1$56 ==.
	XG$PCA_Init$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$PCA_ISR$0$0 ==.
	C$lab3_1.c$95$1$56 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:95: void PCA_ISR ( void ) __interrupt 9
;	-----------------------------------------
;	 function PCA_ISR
;	-----------------------------------------
_PCA_ISR:
	...
	push	psw
	C$lab3_1.c$97$1$58 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:97: if (CF)
	C$lab3_1.c$99$2$59 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:99: CF = 0;
	jbc	_CF,00109$
	sjmp	00102$
00109$:
	C$lab3_1.c$100$2$59 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:100: PCA0 = 28671; //20 ms period 36408
	mov	((_PCA0 >> 0) & 0xFF),#0xff
	mov	((_PCA0 >> 8) & 0xFF),#0x6f
	C$lab3_1.c$101$2$59 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:101: count ++;
	inc	_count
	clr	a
	cjne	a,_count,00104$
	inc	(_count + 1)
...
00102$:
	C$lab3_1.c$105$2$60 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:105: PCA0CN &= 0x40;
	anl	_PCA0CN,#0x40
00104$:
	pop	psw
	pop	acc
...
;------------------------------------------------------------
	...
	C$lab3_1.c$109$1$58 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:109: void Set_Pulsewidth()
;	-----------------------------------------
;	 function Set_Pulsewidth
;	-----------------------------------------
_Set_Pulsewidth:
	C$lab3_1.c$111$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:111: printf("Plus or Minus please.\r\n");
	mov	a,#___str_1
	push	acc
	mov	a,#(___str_1 >> 8)
	push	acc
	...
	dec	sp
	C$lab3_1.c$113$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:113: input = getchar();
	lcall	_getchar
	mov	_input,dpl
	C$lab3_1.c$114$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:114: if(input == '+')  // single character input to increase the pulsewidth
	mov	a,#0x2b
	cjne	a,_input,00108$
	C$lab3_1.c$116$2$62 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:116: PW = PW + 200;
	mov	a,#0xc8
	add	a,_PW
	mov	_PW,a
	clr	a
	...
	mov	(_PW + 1),a
	C$lab3_1.c$118$2$62 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:118: if(PW > PW_MAX)  // check if greater than pulsewidth maximum
	clr	c
	mov	a,_PW_MAX
	subb	a,_PW
	mov	a,(_PW_MAX + 1)
	...
	jnc	00109$
	C$lab3_1.c$119$2$62 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:119: PW = PW_MAX;    // set PW to the maximum value
	mov	_PW,_PW_MAX
	mov	(_PW + 1),(_PW_MAX + 1)
	sjmp	00109$
00108$:
	C$lab3_1.c$121$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:121: else if(input == '-')  // single character input to decrease the pulsewidth
	mov	a,#0x2d
	cjne	a,_input,00109$
	C$lab3_1.c$123$2$63 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:123: PW = PW - 200;
	mov	a,_PW
	add	a,#0x38
	mov	_PW,a
	mov	a,(_PW + 1)
	...
	mov	(_PW + 1),a
	C$lab3_1.c$125$2$63 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:125: if(PW < PW_MIN)  // check if less than pulsewidth minimum
	clr	c
	mov	a,_PW
	subb	a,_PW_MIN
	mov	a,(_PW + 1)
	...
	jnc	00109$
	C$lab3_1.c$126$2$63 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:126: PW = PW_MIN;     // set PW to the minimum value
	mov	_PW,_PW_MIN
	mov	(_PW + 1),(_PW_MIN + 1)
00109$:
	C$lab3_1.c$128$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:128: printf("PW: %u\n\r", PW);
	push	_PW
	push	(_PW + 1)
	mov	a,#___str_2
	push	acc
	...
	mov	sp,a
	C$lab3_1.c$129$1$61 ==.
;	C:\Users\gerlig\Documents\School\LITEC\LAB3-1\lab3-1.c:129: PCA0CP2 = 0xFFFF - PW;
	mov	a,#0xff
	clr	c
	subb	a,_PW
	mov	((_PCA0CP2 >> 0) & 0xFF),a

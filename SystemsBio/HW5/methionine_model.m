...
[m,h] = meshgrid(0:1:4000);   %# Create a mesh of m and h points
...
%adohcy nullcline
a2=ezplot(@(m,h) myfun2(m,h), [0 4000 0 40])
...
%adohcy nullcline
a2=ezplot(@(m,h) myfun22(m,h), [0 4000 0 40])
setcurve('color','black','Linewidth', 2) 
